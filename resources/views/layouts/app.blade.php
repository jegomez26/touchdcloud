...
<body class="antialiased bg-gray-100" x-cloak>
    ...
    <div x-data="{
        ...
        currentRegisterRole: '', // To store the selected role (individual, coordinator, provider)
        ...
        <nav class="bg-white border-b border-gray-200 shadow-sm p-4">
            <div class="container mx-auto flex justify-between items-center">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <a href="{{ route('indiv-dashboard') }}" class="text-gray-700 hover:text-indigo-600 font-medium text-lg transition duration-300">Individual</a>
            ...
            <div x-show="showRegisterRoleModal"
                ...
                <div x-show="showRegisterRoleModal"
                    ...
                    <div class="grid grid-cols-1 gap-4">
                        {{-- New: Individual link now sets role and opens initial registration modal --}}
                        <a @click.prevent="currentRegisterRole = 'individual'; showRegisterRoleModal = false; showInitialRegisterModal = true;"
                           class="block w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-4 rounded-lg shadow-md transition duration-300 ease-in-out text-lg cursor-pointer">
                            An Individual (NDIS Participant)
                        </a>
            ...
            <div x-show="showInitialRegisterModal"
                ...
                <div x-show="showInitialRegisterModal"
                    ...
                    <h2 class="text-3xl font-bold text-gray-800 text-center mb-6">
                        Register Account
                        <template x-if="currentRegisterRole === 'individual'"><span class="text-xl block">(NDIS Participant)</span></template>
                    ...
                    <template x-if="currentRegisterRole === 'individual'">
