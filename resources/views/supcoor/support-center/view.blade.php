...
<div class="bg-white shadow-md rounded-lg p-6 mb-6">
    <div class="flex items-center justify-between">
        ...
        <div class="flex items-center space-x-4">
            <a href="{{ route('sc.support-center.index') }}" class="bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition duration-200 flex items-center">
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    ...
    <div class="lg:col-span-2 space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <!-- Add Comment Form -->
            <form method="POST" action="{{ route('sc.support-center.comment', $ticket) }}" class="border-t pt-4">
                @csrf
                <div class="mb-4">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-lg shadow-lg p-6">
            ...
            <div class="space-y-2">
                <a href="{{ route('sc.support-center.index') }}" class="w-full bg-gray-500 text-white px-4 py-2 rounded-lg hover:bg-gray-600 transition duration-200 flex items-center justify-center">
...
<div id="new-ticket-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50 transition-opacity duration-300 ease-out opacity-0 pointer-events-none">
    <div class="bg-white rounded-xl shadow-2xl p-8 max-w-2xl w-full relative transform -translate-y-4 scale-95 transition-all duration-300 ease-out">
        ...
        <form method="POST" action="{{ route('sc.support-center.create') }}">
            @csrf
            <div class="space-y-6">
                <div>
