        ...
        return {
            ...
            sections: {
                basic: {
                    ...
                    route: participantId ? '{{ route("sc.participants.profile.basic-details", ["participant" => ":id"]) }}'.replace(':id', participantId) : '#',
                    routeName: 'sc.participants.profile.basic-details',
                ...
                ndis: {
                    ...
                    route: participantId ? '{{ route("sc.participants.profile.ndis-support-needs", ["participant" => ":id"]) }}'.replace(':id', participantId) : '#',
                    routeName: 'sc.participants.profile.ndis-support-needs',
                    icon: '<svg fill="currentColor" viewBox="0 0 20 20"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>'
                },
                health: {
                    title: 'Health and Safety',
                    route: participantId ? '{{ route("sc.participants.profile.health-safety", ["participant" => ":id"]) }}'.replace(':id', participantId) : '#',
                    routeName: 'sc.participants.profile.health-safety',
                ...
                living: {
                    ...
                    route: participantId ? '{{ route("sc.participants.profile.living-preferences", ["participant" => ":id"]) }}'.replace(':id', participantId) : '#',
                    routeName: 'sc.participants.profile.living-preferences',
                ...
                compatibility: {
                    ...
                    route: participantId ? '{{ route("sc.participants.profile.compatibility-personality", ["participant" => ":id"]) }}'.replace(':id', participantId) : '#',
                    routeName: 'sc.participants.profile.compatibility-personality',
                ...
                availability: {
                    title: 'Availability',
                    route: participantId ? '{{ route("sc.participants.profile.availability", ["participant" => ":id"]) }}'.replace(':id', participantId) : '#',
                    routeName: 'sc.participants.profile.availability',
