            ...
            <div class="bg-[#ffffff] overflow-hidden shadow-sm sm:rounded-lg p-6">
                ...
                <form method="POST" action="{{ route('sc.participants.update', $participant) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <textarea id="specific_disability" name="specific_disability" rows="3" class="block mt-1 w-full border-gray-300 focus:border-[#cc8e45] focus:ring-[#cc8e45] rounded-md shadow-sm bg-[#ffffff] text-[#3e4732]" placeholder="e.g., Dementia, limited mobility, requiring speech therapy.">{{ old('specific_disability', $participant->specific_disability) }}</textarea>
