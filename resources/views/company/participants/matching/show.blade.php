...
document.addEventListener('DOMContentLoaded', function() {
    ...
    findMatchesBtn.addEventListener('click', function() {
        ...
        fetch(`/provider/participants-matching/${currentParticipantId}/find-matches`)
            .then(response => {
                if (!response.ok) {
    ...
    function viewDetails(participantId) {
        ...
        fetch(`/provider/participants/${participantId}/details`)
    ...
    // from provider-db.blade.php parent layout
});
</script>
@endpush
@endsection
